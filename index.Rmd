...
- [Create your own functions for package development in R](pkg-functions.html)

### Analysis workflow:

- [Keeping track of changes to your files with version control](intro-git.html)
- [Best practices in data analysis workflow and project management in R](workflow-setup.html)
